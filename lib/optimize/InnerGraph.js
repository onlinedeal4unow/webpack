 ...
 * @property {TopLevelSymbol|boolean} currentTopLevelSymbol
...
exports.onUsage = (state, onUsageCallback) => {
	...
	if (innerGraphState) {
		...
		if (typeof currentTopLevelSymbol !== "boolean") {
			...
			onUsageCallback(currentTopLevelSymbol);
		}
	} else {
...
/**
 * @param {ParserState} state parser state
 * @param {TopLevelSymbol|boolean} symbol the symbol
 */
...
/**
 * @param {ParserState} state parser state
 * @returns {TopLevelSymbol|boolean} usage data
 */
